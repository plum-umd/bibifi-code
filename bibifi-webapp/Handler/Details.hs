        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <h2 id="scoring">
                    Scoring
                <p>
                    Builder teams and breaker teams are scored <em>separately</em>. 
                <p>
                ...
                <h4>
                    Break-it Round
                <p>
                    For every bug found against your submission during the Break-it phase, you will lose <strong>25 points</strong>. 
                    For every bug found against your submission that leads to a crash, you will lose <strong>50 points</strong>. 
                    For every vulnerability found during the Break-it phase, you will lose <strong>100 points</strong>.<!-- (For what "unique" means, see the Fix-it scoring below.) -->
               <!--  <h4>
                    Fix-it Round
                <p>
                ...
                <ul>
                    ...
                    <li>
                        Course staff reserve the right to use their discretion in making judgements. 
                <h4>
                    Build-it
                <ul>
                    <li>
