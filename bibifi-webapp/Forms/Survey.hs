...
--    <*> areq boolField' "Have you programmed during a full-time job?" Nothing
    ...
    <*> areq (checkBoxField' $ [hamlet|I agree to participate in the research study and the terms in this <a href="@{StaticR doc_consent_form_pdf}" target="_blank">consent form</a>|] render) "Researchers at the University of Maryland are conducting a research study that aims to better understand how to build secure systems. We ask that you allow us to use data gathered from your performance in this contest as part of the study. All personally identifiable information will be anonymized before being shared with the researchers. Agreeing or declining to participate in this research will not affect your grade or standing in this course." (Just $ maybe True formResumePermission formM)
